const baseVariant = {
	...
	destructive:
		"bg-destructive border-destructive-foreground/10 text-destructive-foreground data-[hovered]:bg-destructive/90 data-[pressed]:bg-destructive/70",
	success:
		"bg-success border-success-foreground/10 text-success-foreground data-[hovered]:bg-success/90 data-[pressed]:bg-success/70",
	info: "bg-info border-info-foreground/10 text-info-foreground data-[hovered]:bg-info/90 data-[pressed]:bg-info/70",
	warning:
		"bg-warning border-warning-foreground/10 text-warning-foreground data-[hovered]:bg-warning/90 data-[pressed]:bg-warning/70",
	outline:
